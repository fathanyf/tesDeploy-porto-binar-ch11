...
import { fetchUserGame, fetchUserGamePoint, selectUser } from '../../store/users/UserSlice'
                                ...
                                <div className="card-body box-profile">
                                    {
                                        (id === auth.user?.uid) ? (
                                            ...
                                            <>
                                                <div className="text-center">
                                                    <img className="profile-user-img img-fluid img-circle" src={playerData.avatar} alt="User profile picture" />
                                                </div>
                                                <h3 className="profile-username text-center">{playerData.name}</h3>
                                                <ul className="list-group list-group-unbordered mb-3">
                                                    <li className="list-group-item">
                                                        <b>Address</b> <a className="float-right">{playerData.address}</a>
                                                    </li>
                                                    <li className="list-group-item">
                                                        <b>Phone</b> <a className="float-right">{playerData.phone}</a>
                                                    </li>
                                                </ul>
                                            </>
                                        )
